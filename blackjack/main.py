...
#     comuter_score = sum(computer_cards)
#     print(user_score)
#     print(comuter_score)
# calculate_score(user_cards)
def calculate_score(cards):
    """This function calculates score and also checks if delt cards are a black jack"""
...
def play_game():
  ...
  while game_ended == False:
      ...
      if user_score == 0 or computer_score == 0 or user_score > 21:
          ...
          deal_again = input("Do you want to deal again? n for no y for yes \n")
          if deal_again == 'y':
              user_cards.append(deal_card())
          else:
              game_ended = True
  ...
  print(f"Dealer's  final hand is {computer_cards}, Dealer's score is {computer_score}")
