...
def checkout():
    ...
    total_price = sum(db.get_or_404(Perfume, item['id']).current_price * item['quantity'] for item in cart_items)
    # Clear the cart after checkout
    session['cart'] = []
    # Add your checkout logic here, such as processing payment, updating inventory, etc.
